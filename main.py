...
def create_path(projectid):
    if os.path.exists(f"i:/PROJ/{projectid}/PRODUCTION/") == False:
        src = "i:/PROJ/PRODUCTION/BLANK Production.xlsx"
        os.mkdir(f"i:/PROJ/{projectid}/PRODUCTION/")
        dst = f"i:/PROJ/{projectid}/PRODUCTION/{projectid}_Production_Report.xlsx"
        shutil.copy(src, dst)
        del src, dst
        # print(f"{projectid} created - Production")
    elif os.path.exists(f"i:/PROJ/{projectid}/PRODUCTION/{projectid}_Production_Report.xlsx") == False:
        src = "i:/PROJ/PRODUCTION/BLANK Production.xlsx"
        dst = f"i:/PROJ/{projectid}/PRODUCTION/{projectid}_Production_Report.xlsx"
        shutil.copy(src, dst)
        del src, dst
    ...
    return f"i:/PROJ/{projectid}/PRODUCTION/{projectid}_Production_Report.xlsx"
